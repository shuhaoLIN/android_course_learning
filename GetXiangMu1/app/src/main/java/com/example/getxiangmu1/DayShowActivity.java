...
public class DayShowActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.getxiangmu1.R.layout.activity_day_show);
    ...
    private void initViews() {
        theMainView = (View)findViewById(com.example.getxiangmu1.R.id.DayShowMainView);
        monthTitle = (TextView)findViewById(com.example.getxiangmu1.R.id.monthTitle);
        weekTitle = (TextView)findViewById(com.example.getxiangmu1.R.id.weekTitle);
        yearTitle = (TextView)findViewById(com.example.getxiangmu1.R.id.yearTitle);
        dayTitle = (TextView)findViewById(com.example.getxiangmu1.R.id.dayTitle);
        dayEdit = (EditText)findViewById(com.example.getxiangmu1.R.id.dayEdit);
        clockBtn = (Button)findViewById(com.example.getxiangmu1.R.id.clockBtn);
        doneBtn = (Button)findViewById(com.example.getxiangmu1.R.id.doneBtn);
        backBtn = (Button)findViewById(com.example.getxiangmu1.R.id.back_btn);
    }
